    ...
    public class PlayerAvailability
    {
            ...
            : this()
        {
            ...
            for (var i = 2; i < items.Length; ++i)
            {
                ...
                AddAvailability(Convert.ToInt32(ranges[0]), Convert.ToInt32(ranges[1]), Convert.ToInt32(ranges[2]), Convert.ToInt32(ranges[3]));
            }
        }

        private void AddAvailability(int startHour, int startMinute, int endHour, int endMinute)
        {
